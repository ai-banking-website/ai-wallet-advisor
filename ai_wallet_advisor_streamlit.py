    ...
    if not st.session_state.profile_complete:
        ...
        <div class="card" style="padding:2rem; text-align:center;">
            ...
            <p style="font-size:1.1rem;">
                Before we build your dashboard, tell us a little about your finances.
            </p>
        </div>
        """, unsafe_allow_html=True)

        st.subheader("💰 Let's set up your wallet")

        with st.form("initial_financial_setup"):
            st.write("Enter your numbers below. You can change them later from **Financial Profile**.")

            c1, c2 = st.columns(2)

            with c1:
                setup_income = st.number_input(
                    "💰 Monthly income (₹)",
                    min_value=0.0,
                    value=0.0,
                    step=1000.0,
                ...
                setup_expenditure = st.number_input(
                    "💸 Monthly expenditure (₹)",
                    min_value=0.0,
                    value=0.0,
                    step=500.0,
                ...
                setup_savings = st.number_input(
                    "🏦 Current savings (₹)",
                    min_value=0.0,
                    value=0.0,
                    step=1000.0,
                    help="The amount you currently have saved."
                )

            with c2:
                setup_investments = st.number_input(
                    "📈 Current investments (₹)",
                    min_value=0.0,
                    value=0.0,
                    step=1000.0,
                ...
                setup_monthly_investment = st.number_input(
                ...
                setup_savings_goal = st.number_input(
                    "🎯 Monthly savings goal (₹)",
                    min_value=0.0,
                    value=0.0,
                    step=500.0,
                    help="How much you would like to save each month."
                )

            setup_submitted = st.form_submit_button(
                "🚀 Start my financial dashboard",
                type="primary",
        ...
        if setup_submitted:
            ...
            st.success("✅ Saved! Your personalized dashboard is ready.")
            st.rerun()
        ...
        with right:
            st.markdown(
                '<div class="card"><b>🤖 AI Insight</b><br><br>' +
